<script>
  ...
  var stats = loadAPI("https://lambda.guardianbrothers.com/stats/equityFund1");
  ...
  var positions = loadAPI(
    "https://lambda.guardianbrothers.com/positions/equityFund1"
  );
  ...
  var displayedTrades = [];
  var trades = loadAPI(
    "https://lambda.guardianbrothers.com/trades/equityFund1"
  );
...
>
  ...
  >
    ...
    {#await stats}
      <div />
    {:then stats}
      <div id="statsTitle">{$_("equityFund1.main.title")}</div>
...
<div class="pageContainer">
  <div class="pageContainerInner">
    <h1 id="sectionOverview">{$_("equityFund1.overview.title")}</h1>
    <div class="textBlock">
      <h2>{$_("equityFund1.overview.section1.title")}</h2>
      <p>
        {$_("equityFund1.overview.section1.paragraph1")}
      </p>
      <p>
        {$_("equityFund1.overview.section1.paragraph2")}
      </p>
      <br />
      <h2>{$_("equityFund1.overview.section2.title")}</h2>
      <p>
        {$_("equityFund1.overview.section2.paragraph1")}
      </p>
      <p>
        {$_("equityFund1.overview.section2.paragraph2")}
      </p>
      <br />
    </div>
      ...
      <div class="howItWorksBlocks">
        <div in:fade={{ delay: 500, duration: 500 }}>
          ...
          <p class="howItWorksBlocksTitle">
            {$_("equityFund1.howItWorks.block1.title")}
          </p>
          <p>
            {$_("equityFund1.howItWorks.block1.description")}
          </p>
        </div>
        <div in:fade={{ delay: 1000, duration: 500 }}>
          <p class="howItWorksBlocksNumber">2</p>
          <p class="howItWorksBlocksTitle">
            {$_("equityFund1.howItWorks.block2.title")}
          </p>
          <p>
            {$_("equityFund1.howItWorks.block2.description")}
          </p>
        </div>
        <div in:fade={{ delay: 1500, duration: 500 }}>
          <p class="howItWorksBlocksNumber">3</p>
          <p class="howItWorksBlocksTitle">
            {$_("equityFund1.howItWorks.block3.title")}
          </p>
          <p>
            {$_("equityFund1.howItWorks.block3.description")}
          </p>
        </div>
        <div in:fade={{ delay: 2000, duration: 500 }}>
          <p class="howItWorksBlocksNumber">4</p>
          <p class="howItWorksBlocksTitle">
            {$_("equityFund1.howItWorks.block4.title")}
          </p>
          <p>
            {$_("equityFund1.howItWorks.block4.description")}
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="textBlock diversificationCharts">
      <div style="width: 50%; height: 350px;">
        <h2>{$_("equityFund1.diversification.sectors")}</h2>
        <div id="diversificationChart" style="height:300px" />
      </div>
      <div style="width: 50%; height: 350px;">
        <h2>{$_("equityFund1.diversification.marketCap")}</h2>
        <div id="marketCapChart" style="height:300px" />
      </div>
    </div>
    <h1 id="sectionFundFacts">{$_("equityFund1.fundFacts.title")}</h1>
    <div class="textBlock">
      {#await stats}
        <div />
      {:then stats}
        <div class="fundFactsBlocks" in:fade>
          <table style="width:48%;">
            ...
            <tbody>
              <tr>
                <td>{$_("equityFund1.fundFacts.fundObjective.title")}</td>
                <td>{$_("equityFund1.fundFacts.fundObjective.description")}</td>
              </tr>
              <tr>
                <td>{$_("equityFund1.fundFacts.fundStrategy.title")}</td>
                <td>{$_("equityFund1.fundFacts.fundStrategy.description")}</td>
              </tr>
              <tr>
                <td>{$_("equityFund1.fundFacts.fundAsset.title")}</td>
                <td>{formatter.format(stats[0].value)}</td>
              </tr>
              <tr>
                <td>{$_("equityFund1.fundFacts.nav.title")}</td>
                <td>{formatter.format(stats[0].value / stats[0].shares)}</td>
              </tr>
              <tr>
                <td>{$_("equityFund1.fundFacts.ticker.title")}</td>
                <td>{$_("equityFund1.fundFacts.ticker.description")}</td>
              </tr>
              <tr>
                <td>{$_("equityFund1.fundFacts.numberOfHoldings.title")}</td>
                {#await positions}
                  <td />
                {:then positions}
              ...
              <tr>
                <td
                  >{$_("equityFund1.fundFacts.distributionFrequency.title")}</td
                >
                <td
                  >{$_(
                    "equityFund1.fundFacts.distributionFrequency.description"
                  )}</td
                >
              </tr>
              <tr>
                <td>{$_("equityFund1.fundFacts.grossExpenseRatio.title")}</td>
                <td
                  >{$_(
                    "equityFund1.fundFacts.grossExpenseRatio.description"
                  )}</td
                >
              </tr>
            </tbody>
          ...
          <table style="width:48%;">
            ...
            <tbody>
              <tr>
                <td>{$_("equityFund1.fundFacts.primaryBenchmark.title")}</td>
                <td
                  >{$_(
                    "equityFund1.fundFacts.primaryBenchmark.description"
                  )}</td
                >
              </tr>
              <tr>
                <td>{$_("equityFund1.fundFacts.minimumInvestment.title")}</td>
                <td
                  >{$_(
                    "equityFund1.fundFacts.minimumInvestment.description"
                  )}</td
                >
              </tr>
              <tr>
                <td
                  >{$_(
                    "equityFund1.fundFacts.minimumSubsequentInvestment.title"
                  )}</td
                >
                <td
                  >{$_(
                    "equityFund1.fundFacts.minimumSubsequentInvestment.description"
                  )}</td
                >
              </tr>
              <tr>
                <td>{$_("equityFund1.fundFacts.managementFees.title")}</td>
                <td>{$_("equityFund1.fundFacts.managementFees.description")}</td
                >
              </tr>
              <tr>
                <td>{$_("equityFund1.fundFacts.transactionFees.title")}</td>
                <td
                  >{$_("equityFund1.fundFacts.transactionFees.description")}</td
                >
              </tr>
              <tr>
                <td>{$_("equityFund1.fundFacts.performanceFees.title")}</td>
                <td
                  >{$_("equityFund1.fundFacts.performanceFees.description")}</td
                >
              </tr>
            </tbody>
          </table>
